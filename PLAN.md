...
**Не доделано до M7:** плитка «Back to projects» закрывает микшер, но
никуда не ведёт — библиотеки ещё нет. Как только появится M7, она
дожимает автосейв и уходит в список.
